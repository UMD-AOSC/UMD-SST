...
#ifndef UMDSST_MODELAUX_MODELAUXINCREMENT_H_
#define UMDSST_MODELAUX_MODELAUXINCREMENT_H_
...
namespace umdsst {
  ...
  class ModelAuxIncrement : public util::Printable,
   ...
   public:
    static const std::string classname() {return "umdsst::ModelAuxIncrement";}
...
#endif  // UMDSST_MODELAUX_MODELAUXINCREMENT_H_
