...
#ifndef OISST_MODELAUX_MODELAUXCOVARIANCE_H_
#define OISST_MODELAUX_MODELAUXCOVARIANCE_H_
...
class ModelAuxCovariance : public util::Printable,
 ...
 public:
  static const std::string classname() {return "oisst::ModelBiasCovariance";}
...
#endif  // OISST_MODELAUX_MODELAUXCOVARIANCE_H_
